...
- Working as a Java backend developer with Danish client HelloRetail.
...
- Led a backend team of 5 people towards a successful project initiation.
...
- Led the development of DIRBS Core (previously driven by Qualcomm), a data analytics system to identify counterfeit devices over the network.
- Designed & managed highly-available Flask-based (Python) RESTful APIs to support OLTP queries to the DIRBS System.
...
- Designed and developed Docker-based CI/CD solutions for easy deployment, reducing manual deployment by 90%.
- Introduced Redis-based in-memory cache to minimize the load on the API server by up to 50%.
- Designed and developed real-time process monitoring using StatsD, Python Profiler, and Grafana.
- Provided real-time support for system deployment at Pakistan Telecommunication Authority (PTA).
- Conducted trainings and workshops related to the system inside and outside the country.
...
- Designed & managed highly-available Flask-based (Python) RESTful APIs to support OLTP queries to the system.
